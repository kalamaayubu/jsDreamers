...
const ContinueWithGithub = () => {
  return (
    <div className="flex items-center justify-center gap-4 py-3 px-4 rounded-lg cursor-pointer border border-gray-200 hover:bg-gray-100 hover:border-gray-100 bg-white transition duration-200 ease-in-out">
      <Image
        width={1000}
        height={1000}
